...
AddEventHandler('QBCore:Client:OnPlayerLoaded', function()
    ...
    TriggerServerEvent('shady-vehicleshop:server:addPlayer', citizenid)
    TriggerServerEvent('shady-vehicleshop:server:checkFinance')
...
RegisterNetEvent('QBCore:Client:OnPlayerUnload', function()
    local citizenid = PlayerData.citizenid
    TriggerServerEvent('shady-vehicleshop:server:removePlayer', citizenid)
    PlayerData = {}
end)
...
local vehHeaderMenu = {
    {
        ...
        params = {
            event = 'shady-vehicleshop:client:showVehOptions'
        }
    }
}
...
local financeMenu = {
    {
        ...
        params = {
            event = 'shady-vehicleshop:client:getVehicles'
        }
    }
}
...
local returnTestDrive = {
    {
        ...
        params = {
            event = 'shady-vehicleshop:client:TestDriveReturn'
        }
    }
}
        ...
        while inTestDrive do
            if GetGameTimer() < gameTimer + tonumber(1000 * testDriveTime) then
                ...
                if secondsLeft >= tonumber(1000 * testDriveTime) - 20 or GetPedInVehicleSeat(NetToVeh(testDriveVeh), -1) ~= PlayerPedId() then
                    TriggerServerEvent('shady-vehicleshop:server:deleteVehicle', testDriveVeh)
                    testDriveVeh = 0
                    inTestDrive = false
                ...
                while insideShop do
                    ...
                    vehicleMenu = {
                        ...
                        },
                        {
                            ...
                            params = {
                                event = 'shady-vehicleshop:client:TestDrive',
                            }
                        },
                        {
                            ...
                            params = {
                                isServer = true,
                                event = 'shady-vehicleshop:server:buyShowroomVehicle',
                                args = {
                        ...
                        },
                        {
                            ...
                            params = {
                                event = 'shady-vehicleshop:client:openFinance',
                                args = {
                                    price = getVehPrice(),
                                    buyVehicle = Config.Shops[insideShop]['ShowroomVehicles'][ClosestVehicle].chosenVehicle
                                }
                        ...
                        },
                        {
                            ...
                            params = {
                                event = Config.FilterByMake and 'shady-vehicleshop:client:vehMakes' or 'qb-vehicleshop:client:vehCategories',
                            }
                        },
                    }
                    Wait(1000)
                ...
                while insideShop and PlayerData.job and PlayerData.job.name == Config.Shops[name]['Job'] do
                    ...
                    vehicleMenu = {
                        ...
                        },
                        {
                            ...
                            params = {
                                event = 'shady-vehicleshop:client:openIdMenu',
                                args = {
                        ...
                        },
                        {
                            ...
                            icon = 'fa-solid fa-coins',
                            params = {
                                event = 'shady-vehicleshop:client:openCustomFinance',
                                args = {
                                    price = getVehPrice(),
                                    vehicle = Config.Shops[insideShop]['ShowroomVehicles'][ClosestVehicle].chosenVehicle
                                }
                        ...
                        },
                        {
                            ...
                            icon = 'fa-solid fa-arrow-rotate-left',
                            params = {
                                event = Config.FilterByMake and 'shady-vehicleshop:client:vehMakes' or 'shady-vehicleshop:client:vehCategories',
                            }
                        },
                    }
                    Wait(1000)
...
-- Events
RegisterNetEvent('shady-vehicleshop:client:homeMenu', function()
    exports['qb-menu']:openMenu(vehicleMenu)
end)

RegisterNetEvent('shady-vehicleshop:client:showVehOptions', function()
    exports['qb-menu']:openMenu(vehicleMenu, true, true)
end)

RegisterNetEvent('shady-vehicleshop:client:TestDrive', function()
...
RegisterNetEvent('shady-vehicleshop:client:customTestDrive', function(data)
...
RegisterNetEvent('shady-vehicleshop:client:TestDriveReturn', function()
...
RegisterNetEvent('shady-vehicleshop:client:vehCategories', function(data)
    local catmenu = {}
    ...
    local categoryMenu = {
        {
            ...
            params = {
                event = Config.FilterByMake and 'shady-vehicleshop:client:vehMakes' or 'shady-vehicleshop:client:homeMenu'
            }
        }
    }
    ...
    if Config.HideCategorySelectForOne and tablelength(catmenu) == 1 then
        TriggerEvent('shady-vehicleshop:client:openVehCats', { catName = firstvalue, make = Config.FilterByMake and data.make, onecat = true })
        return
    end
    for k, v in pairs(catmenu) do
        categoryMenu[#categoryMenu + 1] = {
            ...
            params = {
                event = 'shady-vehicleshop:client:openVehCats',
                args = {
                    catName = k,
                }
            }
...
RegisterNetEvent('shady-vehicleshop:client:openVehCats', function(data)
    local vehMenu = {
        {
            header = Lang:t('menus.goback_header'),
            icon = 'fa-solid fa-angle-left',
            params = {
                event = 'shady-vehicleshop:client:vehCategories',
                args = {
                    make = data.make
                }
            }
    ...
    if data.onecat == true then
        vehMenu[1].params = {
            event = 'shady-vehicleshop:client:vehMakes'
        }
    end
    for k, v in pairs(QBCore.Shared.Vehicles) do
                ...
                for _, shop in pairs(QBCore.Shared.Vehicles[k]['shop']) do
                    if shop == insideShop then
                        vehMenu[#vehMenu + 1] = {
                            ...
                            params = {
                                isServer = true,
                                event = 'shady-vehicleshop:server:swapVehicle',
                                args = {
                                    toVehicle = v.model,
...
RegisterNetEvent('shady-vehicleshop:client:vehMakes', function()
    local makmenu = {}
    local makeMenu = {
        {
            header = Lang:t('menus.goback_header'),
            icon = 'fa-solid fa-angle-left',
            params = {
                event = 'shady-vehicleshop:client:homeMenu'
            }
        }
    }
    for k, v in pairs(QBCore.Shared.Vehicles) do
...
RegisterNetEvent('shady-vehicleshop:client:openFinance', function(data)
    ...
    if dialog then
        ...
        TriggerServerEvent('shady-vehicleshop:server:financeVehicle', dialog.downPayment, dialog.paymentAmount, data.buyVehicle)
    end
end)

RegisterNetEvent('shady-vehicleshop:client:openCustomFinance', function(data)
    local dialog = exports['qb-input']:ShowInput({
    ...
    if dialog then
        ...
        TriggerServerEvent('shady-vehicleshop:server:sellfinanceVehicle', dialog.downPayment, dialog.paymentAmount, data.vehicle, dialog.playerid)
    end
end)

RegisterNetEvent('shady-vehicleshop:client:swapVehicle', function(data)
...
RegisterNetEvent('shady-vehicleshop:client:buyShowroomVehicle', function(vehicle, plate)
    tempShop = insideShop -- temp hacky way of setting the shop because it changes after the callback has returned since you are outside the zone
    QBCore.Functions.TriggerCallback('QBCore:Server:SpawnVehicle', function(netId)
        local veh = NetToVeh(netId)
        exports['LegacyFuel']:SetFuel(veh, 100)
...
RegisterNetEvent('shady-vehicleshop:client:getVehicles', function()
    QBCore.Functions.TriggerCallback('shady-vehicleshop:server:getVehicles', function(vehicles)
        local ownedVehicles = {}
        for _, v in pairs(vehicles) do
            ...
            if v.balance ~= 0 and vehData.shop == insideShop then
                ...
                ownedVehicles[#ownedVehicles + 1] = {
                    ...
                    icon = 'fa-solid fa-car-side',
                    params = {
                        event = 'shady-vehicleshop:client:getVehicleFinance',
                        args = {
                            vehiclePlate = plate,
                            balance = v.balance,
...
RegisterNetEvent('shady-vehicleshop:client:getVehicleFinance', function(data)
    local vehFinance = {
        {
            header = Lang:t('menus.goback_header'),
            params = {
        ...
        },
        {
            ...
            icon = 'fa-solid fa-hand-holding-dollar',
            params = {
                event = 'shady-vehicleshop:client:financePayment',
                args = {
                    vehData = data,
        ...
        },
        {
            ...
            params = {
                isServer = true,
                event = 'shady-vehicleshop:server:financePaymentFull',
                args = {
...
RegisterNetEvent('shady-vehicleshop:client:financePayment', function(data)
    local dialog = exports['qb-input']:ShowInput({
    ...
    if dialog then
        ...
        TriggerServerEvent('shady-vehicleshop:server:financePayment', dialog.paymentAmount, data.vehData)
    end
end)

RegisterNetEvent('shady-vehicleshop:client:openIdMenu', function(data)
    local dialog = exports['qb-input']:ShowInput({
    ...
    if dialog then
        ...
        if data.type == 'testDrive' then
            TriggerServerEvent('shady-vehicleshop:server:customTestDrive', data.vehicle, dialog.playerid)
        elseif data.type == 'sellVehicle' then
            TriggerServerEvent('shady-vehicleshop:server:sellShowroomVehicle', data.vehicle, dialog.playerid)
        end
    end
end)
